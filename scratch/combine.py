...
with codecs.open('scratch/current_dash.py', 'r', encoding='utf-8') as f:
    lines = f.readlines()
...
# Fix the CSS block to strip out the sidebar radio stuff if needed, but we don't even have a sidebar anymore! 
# We'll just leave it since it won't hurt, but let's make sure native tabs aren't broken.
...
with tab1:
    ...
    with op_c2:
        ...
        feed_html = "<div class='terminal-feed' style='height: 420px;'><div style='color:#0f172a;'>"
