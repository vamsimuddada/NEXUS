...
**Generated:** 2026-09-13 10:11 UTC  
...
NOVA's evasion rate grows from 0.0% in Battle 1 to 60.0% at peak, demonstrating empirical threshold learning across battles. The probe→measure→craft→exploit pipeline converges on the GNN decision boundary without access to model internals.
