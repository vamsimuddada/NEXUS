...
\textbf{Generated:} 2026-09-13 06:17 UTC  
...
NOVA's evasion rate grows from 0.0\% in Battle 1 to 100.0\% at peak, demonstrating empirical threshold learning across battles. The probeâ†’measureâ†’craftâ†’exploit pipeline converges on the GNN decision boundary without access to model internals.
