...
# 2. About Page (current)
about_start = code.find('# ------------------------------------------------------------------------------\\n#  ABOUT PROJECT PAGE (ROUTING)')
about_end = code.find('st.stop()') + len('st.stop()')

# 3. Global Theme
theme_start = code.find('# ------------------------------------------------------------------------------\\n#  GLOBAL THEME')
theme_end = code.find('""", unsafe_allow_html=True)', theme_start) + len('""", unsafe_allow_html=True)')
