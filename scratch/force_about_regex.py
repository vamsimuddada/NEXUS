...
# Remove the duplicate simulation lifecycle which is the SECOND occurrence of Simulation Lifecycle
text = re.sub(
...
# We only want to apply this between the MANIFESTO and Tech Stack
