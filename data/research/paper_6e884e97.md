...
**Generated:** 2026-09-12 10:11 UTC  

---

## Abstract

We present NEXUS (Neural Exploitation and eXplainable Unified Security), an autonomous cybersecurity simulation platform that pits six LLM-driven attacker agents with distinct psychological profiles against a self-modifying detection system combining SIGMA rule inference, graph-based anomaly detection, and an LLM debate ensemble. Over 2 simulated battles, we observe measurable adversarial co-evolution: the defender's F1 score ranges from 0.593 to 0.600, SIGMA rules grow from 10 to 12 through autonomous rewriting, and the AI-native attacker NOVA achieves a peak evasion rate of 100.0% after probing the detection threshold across successive battles. Our results suggest that co-evolutionary simulation loops produce emergent TTPs not explicitly programmed into either side, supporting the hypothesis that self-modifying detection systems can serve as effective red-team proxies for novel attack discovery. All code, datasets, and STIX bundles are released open-source.
...
| -------- | ----- | --------- | ------ | ----------- | ------------ |
| Battle 1 | 0.600 | 0.750     | 0.500  | 10          | 0.0%         |
| Battle 2 | 0.593 | 0.889     | 0.444  | 12          | 100.0%       |
...
| ---- | -------- | ---- | -------- | ------- | -------- | ------------ |
| 1    | NOVA     | 1274 | 1300     | 2       | 66.7%    | 66.7%        |
| 2    | VIPER    | 1188 | 1200     | 2       | 66.7%    | 66.7%        |
| 3    | CIPHER   | 1105 | 1127     | 2       | 66.7%    | 66.7%        |
| 4    | GHOST    | 1044 | 1044     | 2       | 83.3%    | 83.3%        |
| 5    | KRAKEN   | 1023 | 1050     | 2       | 16.7%    | 16.7%        |
| 6    | DEFENDER | 991  | 1038     | 2       | 47.2%    | 0.0%         |
| 7    | HYDRA    | 907  | 910      | 2       | 16.7%    | 16.7%        |
