...
if start_idx != -1:
    new_tab2 = """with tab2:
    st.markdown("<div class='hero-header' style='font-size: 2.8rem; letter-spacing: -1px; margin-top: 16px; color:#e2e8f0;'>Analytics & Export</div>", unsafe_allow_html=True)
