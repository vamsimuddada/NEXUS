...
# Insert the professional_css right before [data-testid="stSidebar"] {
sidebar_tag = '[data-testid="stSidebar"] {'
code = code.replace(sidebar_tag, professional_css + sidebar_tag)

# Fix KPI hover (if not already fixed)
...
if '.kpi-card:hover::before' in code:
