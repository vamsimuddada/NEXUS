...
# I will find 'with r2:' and replace everything up to 'except Exception as e:'
            ...
            with st.container(border=True):
                ...
                for t in techs:
                    ...
                    if t in STATIC_TECHNIQUES:
                        ...
                        playbook_items.append((t_name, STATIC_TECHNIQUES[t]['detection'], STATIC_TECHNIQUES[t]['mitigation']))
