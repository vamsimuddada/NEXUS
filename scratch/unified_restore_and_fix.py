...
# ==========================================
# 1. FIX THE ABOUT PAGE
# ==========================================
# Change About NEXUS to PROJECT NEXUS MANIFESTO and update font
text = re.sub(
    r"<div style='font-family:\\'Space Grotesk\\', sans-serif; font-size:3rem; font-weight:800; color:#0f172a; margin-bottom:16px;'>About NEXUS</div>",
...
# Update System Architecture font
text = re.sub(
    r"<h3 style='font-family:\\'Space Grotesk\\', sans-serif; font-weight:800; color:#0f172a; margin-bottom:24px;'>System Architecture</h3>",
...
# Update Red Team font
text = re.sub(
    r"<div style='font-family:\\'Space Grotesk\\', sans-serif; font-size:1.3rem; font-weight:800; color:#0f172a;'>Red Team \(Autonomous Attackers\)</div>",
...
# Update Blue Team font
text = re.sub(
    r"<div style='font-family:\\'Space Grotesk\\', sans-serif; font-size:1.3rem; font-weight:800; color:#0f172a;'>Blue Team \(SIEM & Defense\)</div>",
...
# Update AI Brain font
text = re.sub(
    r"<div style='font-family:\\'Space Grotesk\\', sans-serif; font-size:1.3rem; font-weight:800; color:#0f172a;'>The AI Brain & Technology Stack</div>",
...
text = pattern_dupe.sub("", text)

# Fix remaining Simulation Lifecycle & Tech Stack headers
text = text.replace(
...
# Remove emoji from back button
text = text.replace('st.button("⬅ Back to Command Center")', 'st.button("BACK TO COMMAND CENTER")')

# ==========================================
# 2. FIX TAB 2 (THREAT INTELLIGENCE)
# ==========================================
pattern_tab2 = re.compile(r'with tab2:.*?with tab3:', re.DOTALL)
new_tab2 = """with tab2:
...
text = pattern_tab2.sub(new_tab2, text)
