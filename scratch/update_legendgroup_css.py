...
# Update the CSS to target the legendgroup class!
old_css_block = """/* 1. Animate the laser lines (Signature: 1000px) */
...
new_css_block = """/* 1. Animate the laser lines using the bulletproof legendgroup class target! */
@keyframes laser-shoot {
    0% { stroke-dasharray: 800; stroke-dashoffset: 800; }
    50% { stroke-dasharray: 800; stroke-dashoffset: 0; opacity: 1; }
    100% { stroke-dasharray: 800; stroke-dashoffset: 0; opacity: 0; }
