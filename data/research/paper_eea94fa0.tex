...
\title{NEXUS EXECUTIVE INCIDENT REPORT}
\author{NEXUS Autonomous Operations Center}
\date{\today}
...
\textbf{Generated:} 2026-09-14 18:42 UTC  

\hrule\vspace{6pt}

\begin{abstract}

We present NEXUS (Neural Exploitation and eXplainable Unified Security), an autonomous cybersecurity simulation platform that pits six LLM-driven attacker agents with distinct psychological profiles against a self-modifying detection system combining SIGMA rule inference, graph-based anomaly detection, and an LLM debate ensemble. Over 3 simulated battles, we observe measurable adversarial co-evolution: the defender's F1 score ranges from 0.909 to 1.000, SIGMA rules grow from 10 to 11 through autonomous rewriting, and the AI-native attacker NOVA achieves a peak evasion rate of 50.0\% after probing the detection threshold across successive battles. Our results suggest that co-evolutionary simulation loops produce emergent TTPs not explicitly programmed into either side, supporting the hypothesis that self-modifying detection systems can serve as effective red-team proxies for novel attack discovery. All code, datasets, and STIX bundles are released open-source.
...
Battle 2 & 0.909 & 1.000 & 0.833 & 10 & 40.0\% \\
...
1 & DEFENDER & 1032 & 1389 & 1377 & 70.8\% & 0.0\% \\
2 & NOVA & 909 & 1300 & 1377 & 61.7\% & 61.7\% \\
3 & GHOST & 765 & 982 & 1377 & 26.2\% & 26.2\% \\
4 & KRAKEN & 741 & 1050 & 1377 & 33.4\% & 33.4\% \\
5 & VIPER & 736 & 1200 & 1377 & 29.5\% & 29.5\% \\
6 & HYDRA & 712 & 960 & 1377 & 1.9\% & 1.9\% \\
7 & CIPHER & 706 & 1100 & 1377 & 22.4\% & 22.4\% \\
...
T1204 & 1 & 1 & 100.0\% & 0.0\% \\
T0001 & 1 & 1 & 100.0\% & 0.0\% \\
T1078 & 5897 & 2686 & 45.5\% & 54.5\% \\
T1071 & 3537 & 1267 & 35.8\% & 64.2\% \\
T1003 & 1642 & 547 & 33.3\% & 66.7\% \\
T1059 & 3226 & 508 & 15.7\% & 84.3\% \\
T1083 & 1915 & 175 & 9.1\% & 90.9\% \\
T1021 & 1059 & 35 & 3.3\% & 96.7\% \\
T1486 & 538 & 6 & 1.1\% & 98.9\% \\
T1055 & 99 & 1 & 1.0\% & 99.0\% \\


\subsection{4.4 NOVA Adversarial Evasion Trend}

NOVA's evasion rate grows from 0.0\% in Battle 1 to 50.0\% at peak, demonstrating empirical threshold learning across battles. The probeâ†’measureâ†’craftâ†’exploit pipeline converges on the GNN decision boundary without access to model internals.
...
VIPER & 17 & T1078 & 0.72 \\
KRAKEN & 17 & T1003 & 0.65 \\
GHOST & 17 & T1078 & 0.70 \\
HYDRA & 17 & T1059 & 0.65 \\
NOVA & 17 & T1071 & 0.62 \\
CIPHER & 17 & T1078 & 0.69 \\
