...
<div style="font-family:'Space Grotesk', sans-serif; font-size: 1.15rem; font-weight: 900; color: #0f172a; letter-spacing: -0.5px;">{t_label}</div>
<div style="background: #f8fafc; color: #64748b; font-family: 'JetBrains Mono', monospace; font-size: 0.75rem; padding: 4px 12px; border-radius: 20px; font-weight: 700; border: 1px solid #e2e8f0; letter-spacing: 0.5px;">ACTIVE THREAT</div>
</div>
...
<div style="background: rgba(245,158,11,0.15); color: #d97706; border: 1px solid rgba(245,158,11,0.3); padding: 4px 10px; border-radius: 6px; font-weight: 800; font-size: 0.7rem; font-family: 'JetBrains Mono', monospace; letter-spacing: 0.5px;">SIEM DETECTION RULE</div>
</div>
<div style="font-family:'Space Grotesk', sans-serif; font-size: 0.9rem; color: #475569; line-height: 1.6;">{det}</div>
</div>
<div style="background: #f8fafc; padding: 20px; border-radius: 8px; border: 1px dashed rgba(16,185,129,0.3);">
<div style="display: flex; align-items: center; gap: 8px; margin-bottom: 12px;">
<div style="background: rgba(16,185,129,0.15); color: #10b981; border: 1px solid rgba(16,185,129,0.3); padding: 4px 10px; border-radius: 6px; font-weight: 800; font-size: 0.7rem; font-family: 'JetBrains Mono', monospace; letter-spacing: 0.5px;">NETWORK REMEDIATION</div>
</div>
<div style="font-family:'Space Grotesk', sans-serif; font-size: 0.9rem; color: #475569; line-height: 1.6;">{mit}</div>
</div>
</div>
</div>
\"\"\"
...
if idx != -1:
    text = text[:idx] + threat_record_html + '\n\n' + text[idx:]
